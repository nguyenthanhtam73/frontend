...
const GUIDES = [
  ...
  {
    slug: "kich-ung-adapalene",
    kicker: "Kích ứng hàng rào",
    title: "Dừng kích, dịu da",
    accent: "#C45C74",
    wash: "#F8E8EC",
  },
  {
    slug: "tham-vs-nam",
    kicker: "Thâm và nám",
    title: "Không tự chẩn, chống nắng",
    accent: "#7A5A8A",
    wash: "#F1E8F4",
  },
  {
    slug: "mun-an",
    kicker: "Mụn ẩn · da dầu",
    title: "Chậm, BHA từ từ, không nặn",
    accent: "#C45C74",
    wash: "#F8E8EC",
  },
  {
