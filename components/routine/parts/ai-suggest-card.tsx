      ...
      <div className="relative space-y-3">
        ...
        <div className="space-y-1.5">
          ...
          <input
            ...
            className="h-11 w-full rounded-xl border bg-background/70 px-3 text-base outline-none ring-ring/40 transition focus:border-primary focus:ring-2 sm:h-9 sm:text-sm"
          />
        </div>
        <Button
          type="button"
