    ...
    <div ref={editorTopRef} className="space-y-4 pb-40 sm:space-y-5 lg:pb-0">
      ...
      <HistoryStrip
        ...
        labels={{
          ...
          bestStreak: t("historyBestStreak"),
          bestStreakUnit: t("historyBestStreakUnit"),
          chartTitle: t("historyChartTitle"),
          trendImproving: t("historyTrendImproving"),
          trendDeclining: t("historyTrendDeclining"),
          trendSteady: t("historyTrendSteady"),
          weeklyAvg: t("historyWeeklyAvg"),
          weekLabel: (n: number) => t("historyWeekLabel", { n }),
          range14: t("historyRange14"),
          range30: t("historyRange30"),
          rangeLabel: t("historyRangeLabel"),
          noSave: t("historyNoSave"),
