...
/**
 * Marketing diary-card preview. Reactions are omitted on purpose (demo only,
 * no API). Optional `photoSrc` swaps the CSS gradient for a product screenshot.
 */
export function SkinCheckCard({
  entry,
  photoSrc,
  photoAlt,
}: {
  ...
  const mediaLabel = photoAlt ?? `${entry.title} — ${entry.focus}`;
